  ...
  <main class="pt-6">
    ...
    <section class="relative h-96 overflow-hidden">
      ...
      <div class="absolute bottom-6 left-6 text-white">
        <span class="bg-indigo-600 text-white px-2 py-1 rounded text-sm">Workshop</span>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white p-6 rounded-lg shadow">
              ...
              <ul class="space-y-2 text-gray-600 text-sm">
                <li>{{ $event_details->what_to_expect }}</li>

              </ul>
            </div>
            <div class="bg-white p-6 rounded-lg shadow">
              <h3 class="text-xl font-bold mb-4">What to Bring</h3>
              <ul class="space-y-2 text-gray-600 text-sm">
                <li>{{ $event_details->prerequisites }}</li>
              </ul>
            </div>
          </div>
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white p-6 rounded-lg shadow">
            ...
            <a href="{{ route('front.event.getticket', $event_details->id) }}" 
          ...
          <div class="bg-white p-6 rounded-lg shadow">
            ...
            <p class="text-sm mt-2">👥 {{ $attendees_count }} people attending</p>
          ...
          <div class="bg-white p-6 rounded-lg shadow">
            ...
            <p class="font-medium mb-2">Winnipeg Healing Center</p>
