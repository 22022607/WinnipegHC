      ...
      <div id="basic" class="tab-content active space-y-6">
        ...
        <form action="{{ route('front.event.store') }}" method="post">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="title" class="w-full border rounded-lg p-2" placeholder="e.g., Meditation Workshop" />
          </div>

          <!-- Event Description -->
          <div class="mb-4">
            <label class="block mb-1 text-sm font-medium">Description</label>
            <textarea class="w-full border rounded-lg p-2" name="description" rows="4" placeholder="Describe your event..."></textarea>
          </div>
          ...
          <div class="grid md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input type="text" name="category" class="w-full border rounded-lg p-2" placeholder="Workshop, Certification" />
            </div>
            <div>
              <label class="block mb-1 text-sm font-medium">Duration</label>
              <input type="text" name="duration" class="w-full border rounded-lg p-2" placeholder="2 hours, 1 day" />
            </div>
          </div>
          ...
          <div class="grid md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
              ...
              <input type="time" name="start_time" class="w-full border rounded-lg p-2" />
            </div>
            <div>
              <label class="block mb-1 text-sm font-medium">End Time</label>
              <input type="time" name="end_time" class="w-full border rounded-lg p-2" />
            </div>
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="text" name="location" class="w-full border rounded-lg p-2" placeholder="Studio A, Main Hall, Zoom" />
          </div>
          <div>
...
<div id="tickets" class="tab-content space-y-6">
        ...
        <input type="number" name="ticket_price" class="w-full border rounded-lg p-2" placeholder="0.00" />

        <label class="block text-sm font-medium">Max Attendees</label>
        <input type="number" name="max_attendees" class="w-full border rounded-lg p-2" placeholder="20" />

        <label class="block text-sm font-medium">Early Bird Price (Optional)</label>
        <input type="number" name="early_price" class="w-full border rounded-lg p-2" placeholder="0.00" />

        <label class="block text-sm font-medium">Ticket Sales Start</label>
        <input type="datetime-local" name="sales_start" class="w-full border rounded-lg p-2" />

        <label class="block text-sm font-medium">Ticket Sales End</label>
        <input type="datetime-local" name="sales_end" class="w-full border rounded-lg p-2" />
      ...
      <div id="settings" class="tab-content space-y-6">
        <div class="bg-white shadow rounded-lg p-6">
          ...
          <textarea class="w-full border rounded-lg p-2 mb-4" name="prerequisites" rows="3" placeholder="Any requirements?"></textarea>

          <!-- What to Expect -->
          <label class="block mb-1 text-sm font-medium">What to Expect</label>
          <textarea class="w-full border rounded-lg p-2 mb-4" name="what_to_expect" rows="3" placeholder="Describe attendee experience"></textarea>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="email" name="email" class="w-full border rounded-lg p-2" placeholder="event@yourbusiness.com" />
            </div>
            <div>
              <label class="block mb-1 text-sm font-medium">Contact Phone</label>
              <input type="tel" name="phone_number" class="w-full border rounded-lg p-2" placeholder="(555) 123-4567" />
            </div>
          </div>
        </div>
      </div>
